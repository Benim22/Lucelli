          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-2">
                <Label>E-post</Label>
                <p className="text-sm text-muted-foreground">{user?.email || "Inte inloggad"}</p>
              </div>
              <div className="grid gap-2">
                <Label>Inloggningsmetod</Label>
                <p className="text-sm text-muted-foreground capitalize">{user?.provider || "Inte inloggad"}</p>
              </div>
            </CardContent>
          </Card>
        </div>
